...
namespace prid_2122_f02 {
    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            services.AddDbContext<Context>(opt => opt.UseSqlite("data source=prid_2122_f02.db"));
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "prid_2122_f02", Version = "v1" });
            });
            ...
            services.AddScoped(provider => new MapperConfiguration(cfg => {
                ...
                cfg.UseEntityFrameworkCoreModel<Context>(services);
            }).CreateMapper());
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, Context context) {
            if (env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "prid_2122_f02 v1"));
            }
